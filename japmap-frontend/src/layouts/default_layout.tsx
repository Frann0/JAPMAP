...
const Default_Layout = () => {
  ...
  const [gitlabToken, setGitlabToken] = useState(
    localStorage.getItem("X-Gitlab-Token") || "",
  );
  const [nomadToken, setNomadToken] = useState(
    localStorage.getItem("X-Nomad-Token") || "",
  );
    ...
    <>
          ...
          >
            ...
            <div className="Add_ModalContent_Container">
              <p className="Add_ModalContent_ContainerText">
                For at kunne kommunikere med Gitlab og Nomad, skal der tilføjes
                auth tokens til brugeren.
                <br />
                <br />
                Disse tokens vil blive gemt i localstorage og bruges til at
                hente data fra de respektive services.
              </p>
              <Input
                label="Gitlab Token"
                value={gitlabToken}
            ...
            <div className="Add_ModalContent_Buttons">
              <button
                ...
                disabled={gitlabToken === "" && nomadToken === ""}
                onClick={() => setTokens()}
              >
                Bekræft
              </button>
      ...
      <div className="Default">
        <div className="Default_Sidebar">
          <Link to={"/projekter"} className="Logo">
            JAPMAP
          </Link>
              ...
              <>
                {!route.internal ? (
                  <Link
                    to={route.path}
                    key={route.path}
                    className="Default_SidebarLinks_Link"
                  >
                    {route.name}
                  </Link>
                ) : null}
          ...
          <div className="Default_SidebarUser">
            ...
            <div
              ...
              className="Default_SidebarUserLogout"
            >
              Logout
            </div>
          </div>
